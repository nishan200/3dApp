...
$(document).ready(function(){
	...
	$.getJSON('./application/model/data.json', function(jsonObj) {
	   ...
	   $('#mainImg').html(jsonObj.pageTextData[9].MainImg);
	   $('.cokeImg').html(jsonObj.pageTextData[9].CokeImg);
	   $('#spriteImg').html('<h2>' + jsonObj.pageTextData[9].SpriteImg + '<h2>');
	   $('#pepperImg').html('<h2>' + jsonObj.pageTextData[9].PepperImg + '<h2>');
